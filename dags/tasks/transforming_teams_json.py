...
def transforming_teams(**kwargs):
    ...
    s3_json_key = f'raw_data/teams/teams.json'

    teams_json = read_json_s3(bucket_name=bucket_name, key = s3_json_key)['teams']
